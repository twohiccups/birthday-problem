                ...
                <AnimatePresence>
                    {collisions > 0 && (
                        <motion.span
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2   text-tiny sm:text-xs inline-flex h-3 w-3  sm:min-w-5 sm:min-h-5 items-center justify-center rounded-full border border-red-400 bg-red-100 font-lexend-deca  font-bold  text-red-700"
                    ...
                    week.map((day, di) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`relative z-10 ${count > 0 ? "text-black font-extralight" : ""}`}>
                                    {hidden ? "•" : day}
                                </span>
                                ...
                                <AnimatePresence>
                                    {!hidden && count > 1 && (
                                        <motion.span
                                            ...
                                            className="absolute -top-2 -right-2 flex h-3 w-3 sm:h-5 sm:w-5 items-center justify-center rounded-full border border-white bg-red-600 text-[10px] font-bold z-50 font-lexend-deca text-white shadow"
